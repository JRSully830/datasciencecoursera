...
#open png device directly to address legend truncation
png(paste0(DataDir,"plot4.png"),type="windows")


par(mfrow=c(2,2),mar=c(4,4,3,1))
## plot linegraph with legend to png device directly
 with(housCons2, {
                plot(Datetime2,Global_active_power,type="l",
                    ylab="Global Active Power",xlab="")
                
                plot(Datetime2,Voltage,type="l",
                    ylab="Voltage",xlab="datetime")
                   
                plot(Datetime2,Sub_metering_1,type="n",
                     ylab="Energy Sub Metering",xlab="")
                lines(Datetime2,Sub_metering_1,type="l",col="black")
                lines(Datetime2,Sub_metering_2,type="l",col="red")
                lines(Datetime2,Sub_metering_3,type="l",col="blue")
                legend("topright",col=c("black","red","blue"),lty=1,bty="n",
                  legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
                
                plot(Datetime2,Global_reactive_power,type="l",
                     xlab="datetime")
                })
